...
def execute_section5():
    ...
    for g in new_groups:
        ...
        # CPC Bid - Optional, usually inherits or relies on bidding strategy, setting a default just in case
        ag.cpc_bid_micros = 1000000  # $1.00
        ag_ops.append(op)
        
    print(f"Creating {len(new_groups)} new DSA AdGroups...")
    ...
    def create_webpage_op(ad_group_res, url_contains):
        ...
        # Slightly higher bid for these precise targets (e.g., $1.50)
        agc.cpc_bid_micros = 1500000
        return op
