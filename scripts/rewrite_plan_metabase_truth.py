# Full overhaul script based 100% on Metabase Real Registrations & Valid Users
plan_content = """# 🚀 Google Ads 本周全量深度优化与矩阵拓量执行大案 (2026-08-11 旗舰落地版 - Metabase 真实注册数据核准)
...
2.  **每日 Metabase 真实注册与单价监控脚本**：
    ```bash
    d:\Apidog Work\Google ADS Keywords Unit Price\run_report.bat
    ```
...
with open(r"d:\Apidog Work\Google ADS Keywords Unit Price\Weekly_Plans\Google_Ads_Execution_Plan_2026_08_11.md", 'w', encoding='utf-8') as f:
    f.write(plan_content)

with open(r"d:\Apidog Work\Google ADS Keywords Unit Price\reports\Google_Ads_Weekly_Execution_Plan_2026_08_11.md", 'w', encoding='utf-8') as f:
    f.write(plan_content)

print("SUCCESS: Both plan files updated based 100% on Metabase Real Registrations & Valid Users!")
