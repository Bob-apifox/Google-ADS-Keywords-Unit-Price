...
CONFIG = [
    ...
    },
    {
        ...
        "ad_group": "Thunder-Client & REST-Client",
        "match_types": ["PHRASE", "EXACT"],
    ...
    {
        "campaign": "Google-Sa-Brand-Global",
        "ad_group": "Brand Download",
        "match_types": ["EXACT"],
        "keywords": ["apidog download", "download apidog", "api dog download"],
        "final_urls": ["https://apidog.com/"]
    },
    {
...
def execute_section2():
    ...
    # 1. Fetch AdGroup IDs for the requested Campaign + AdGroup combos
    ag_map = {}
    q_ag = """
    ...
    if ops:
        print(f"Uploading {len(ops)} keywords with Final URLs...")
